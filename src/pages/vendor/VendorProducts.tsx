...
const empty: ProductForm = {
  ...
  is_rentable: false, is_purchasable: true,
...
export default function VendorProducts() {
  ...
  const saveMutation = useMutation({
    mutationFn: async () => {
      ...
      const payload = { ...form, stock: form.total_inventory, vendor_id: vendor.id };
      if (editId) {
  ...
  return (
    <VendorLayout>
      <div className="flex items-center justify-between mb-6">
        <h1 className="font-heading font-bold text-2xl">Produk Saya</h1>
