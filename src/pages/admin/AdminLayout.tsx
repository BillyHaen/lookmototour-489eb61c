...
import { Loader2, LayoutDashboard, CalendarDays, Users, ShoppingBag, MessageSquare, Settings, ArrowLeft, FileText, BookOpen, Menu, X, Image as ImageIcon, Handshake, Building2, Package, Mail, ShieldCheck, Activity } from 'lucide-react';
...
const ADMIN_NAV = [
  ...
  { label: 'Status Deploy', path: '/admin/deployment', icon: Activity },
