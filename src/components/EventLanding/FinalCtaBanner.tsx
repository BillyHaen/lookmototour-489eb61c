...
export default function FinalCtaBanner({ ctaLabel, spotsLeft, onCtaClick }: Props) {
  return (
    <section className="my-12 rounded-2xl bg-gradient-hero text-primary-foreground p-8 md:p-12 text-center">
      ...
      <Button size="lg" variant="secondary" onClick={onCtaClick} className="gap-2 text-base font-semibold">
        {ctaLabel || '🔥 Join The Ride – Apply Now'}
      </Button>
    </section>
  );
}
